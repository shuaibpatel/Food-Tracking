...
class AnalyticsControllerTest < ActionController::TestCase
  ...
  test "should create analytic" do
    assert_difference('Analytic.count') do
      post :create, analytic: { Calories: @analytic.Calories, Carbohydrates: @analytic.Carbohydrates, Country: @analytic.Country, Day: @analytic.Day, Fats: @analytic.Fats, Food: @analytic.Food, Protein: @analytic.Protein }
    end
  ...
  test "should update analytic" do
    patch :update, id: @analytic, analytic: { Calories: @analytic.Calories, Carbohydrates: @analytic.Carbohydrates, Country: @analytic.Country, Day: @analytic.Day, Fats: @analytic.Fats, Food: @analytic.Food, Protein: @analytic.Protein }
    assert_redirected_to analytic_path(assigns(:analytic))
  end
