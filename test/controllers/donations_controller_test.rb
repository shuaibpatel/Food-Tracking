...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { cost: @donation.cost, description: @donation.description, firstname: @donation.firstname, lastname: @donation.lastname }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { cost: @donation.cost, description: @donation.description, firstname: @donation.firstname, lastname: @donation.lastname }
    assert_redirected_to donation_path(assigns(:donation))
  end
